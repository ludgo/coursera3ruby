Rails.application.routes.draw do
  ...
  patch "api/races/:race_id/results/:id" => "api/races#results_update"

  get "api/racers" => "api/racers#index"
  get "api/racers/:id" => "api/racers#show"
  get "api/racers/:racer_id/entries" => "api/racers#entries_all"
  get "api/racers/:racer_id/entries/:id" => "api/racers#entries_one"
